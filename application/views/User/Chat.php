            ...
            <div class="chat-window">
                <div class="chat-header">
                    <div class="d-flex align-items-center">
                        ...
                        <img src="<?php echo  !empty($astrologer['profile_pic']) ? base_url("/uploads/Astologer/".$astrologer['profile_pic']) :base_url('assets/images/astrologerimg.png')?>" alt="Profile Image" class="profile-img rounded-circle" width="30px" height="30px">
