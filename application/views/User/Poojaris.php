        ...
        <div class="container">
            ...
            <div class="row my-4">
                <div class="col-12 col-md-6 d-flex gap-3 align-items-center">
                    ...
                    <select class="form-select w-auto shadow-none" aria-label="Filter by distance">
                        ...
                        <div class="card shadow rounded-3 h-100 position-relative" style="border: 2px solid var(--red); ">
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="d-flex gap-2">
                                    <a href="<?php echo base_url('BookPoojaViewMore') ?>" class="w-100 text-decoration-none text-dark">
