...
<body>
    ...
    <div class="container p-3 my-4 rounded-3" style="background-color: #fff7b8;">
        <h3 class="text-center mb-3">Shadbala Analysis</h3>
        <div class="row flex-col justify-content-center align-items-start">
            <div class="col-12 col-md-6">
                <div class="text-center">
                    <img src="<?php echo base_url('assets/images/FreeKundli/kundli.png')?>" alt="Shadbala Chart" class="img-fluid"
                        style="width: 450px; height: 450px; margin-top: 5px;">
                    <h4 class="mt-5">Shadbala by Birth Date</h4>
                    <form id="kundliForm" class="p-3 bg-white shadow rounded">
                        ...
                        <select id="astro_feature" class="form-control shadow-none my-2 p-2 rounded-1" required style="visibility: hidden;">
                            <option value="shadbala" selected>Shadbala</option>
                        </select>
                        <center>
                            <button type="submit" class="btn my-2 p-2 fw-bold rounded-1"
                                style="background-color: var(--yellow);">Get Shadbala Analysis</button>
                        </center>
            ...
            <div class="col-12 col-md-6">
                <div class="mt-2" style="text-align: justify; padding: 0 20px;">
                    <p style="font-weight: 300;">
                        Shadbala is a Vedic astrology concept that quantifies the strength of planets in a natal chart, providing insights into their influence on various aspects of life. It evaluates six sources of strength (Shad means six, Bala means strength) to determine how effectively a planet can manifest its qualities.
                    </p>
                    <h4 class="mt-4 d-flex align-items-center justify-content-center gap-2">
                        <span class="fw-semibold">Key Components of Shadbala</span>
                    </h4>
                    <div class="mt-4 px-2">
                        <h5 class="fw-bold mb-3">Sthana Bala (Positional Strength):</h5>
                        <p class="text-justify mb-4">
                            Derived from a planet’s position in exalted, own, friendly, or debilitated signs, as well as its placement in specific houses, influencing its foundational strength.
                        </p>
                        <h6 class="fw-semibold mb-2">Dig Bala (Directional Strength):</h6>
                        <p class="text-justify mb-4">
                            Based on a planet’s position in specific angular houses (1st, 4th, 7th, 10th), where it gains directional potency to influence life events.
                        </p>
                        <h6 class="fw-semibold mb-2">Kala Bala (Temporal Strength):</h6>
                        <p class="text-justify mb-4">
                            Determined by factors like time of birth (day/night), lunar phase, or planetary periods, reflecting a planet’s strength at specific times.
                        </p>
                        <h6 class="fw-semibold mb-2">Chesta Bala (Motional Strength):</h6>
                        <p class="text-justify mb-4">
                            Measures a planet’s motion, with higher strength for fast-moving or retrograde planets, indicating dynamic influence.
                        </p>
                        <h6 class="fw-semibold mb-2">Naisargika Bala (Natural Strength):</h6>
                        <p class="text-justify mb-4">
                            Inherent strength based on a planet’s natural brightness, with the Sun being the strongest and Saturn the weakest.
                        </p>
                        <h6 class="fw-semibold mb-2">Drik Bala (Aspectual Strength):</h6>
                        <p class="text-justify mb-4">
                            Calculated from aspects received from other planets, where benefic aspects increase strength and malefic aspects reduce it.
                        </p>
                    </div>
                    <div class="mt-4 px-2">
                        <h5 class="fw-bold mb-3">Significance of Shadbala:</h5>
                        <p class="text-justify mb-4">
                            Shadbala helps astrologers assess which planets are most influential in a chart, guiding predictions about career, relationships, health, and spiritual growth. Strong planets indicate areas of ease, while weaker ones highlight challenges or areas needing effort.
                        </p>
                    </div>
                </div>
            </div>
            <div class="col-12">
                <h6 class="fw-semibold mb-2">Shadbala and Life Predictions:</h6>
                <p class="text-justify mb-4">
                    By analyzing Shadbala, astrologers can predict the potency of planetary influences during specific life periods, helping individuals align with favorable energies and mitigate challenges.
                </p>
                <h6 class="fw-semibold mb-2">Technology and Shadbala Analysis:</h6>
                <p class="text-justify mb-4">
                    Advanced astrological software calculates Shadbala with precision, providing detailed insights into planetary strengths for personalized guidance.
                </p>
            </div>
        </div>
    </div>
            ...
            <div class="col-12 col-md-7">
                <div class="card shadow-sm border-0 p-4">
                    <h5 class="mt-0 mb-3 text-primary d-flex align-items-center">
                        <i class="bi bi-stars me-2"></i> 🔮 How Shadbala Impacts Life
                    </h5>
                    <div class="accordion" id="shadbalaImpactAccordion">
                        <div class="accordion-item border-0">
                            ...
                            <div id="collapsePersonality" class="accordion-collapse collapse" aria-labelledby="headingPersonality" data-bs-parent="#shadbalaImpactAccordion">
                                <div class="accordion-body">
                                    Strong Sun or Moon in Shadbala enhances confidence and emotional stability, shaping a resilient and expressive personality.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item border-0">
                            ...
                            <div id="collapseCareer" class="accordion-collapse collapse" aria-labelledby="headingCareer" data-bs-parent="#shadbalaImpactAccordion">
                                <div class="accordion-body">
                                    High Shadbala for Jupiter or Saturn indicates strong potential for career growth, leadership, and sustained success in professional endeavors.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item border-0">
                            ...
                            <div id="collapseRelationships" class="accordion-collapse collapse" aria-labelledby="headingRelationships" data-bs-parent="#shadbalaImpactAccordion">
                                <div class="accordion-body">
                                    A strong Venus or Mars in Shadbala fosters harmonious relationships, attraction, and emotional compatibility.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item border-0">
                            ...
                            <div id="collapseHealth" class="accordion-collapse collapse" aria-labelledby="headingHealth" data-bs-parent="#shadbalaImpactAccordion">
                                <div class="accordion-body">
                                    Strong Sun or Moon in Shadbala supports physical vitality and mental resilience, while weaker planets may indicate health vulnerabilities.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item border-0">
                            ...
                            <div id="collapseSpirituality" class="accordion-collapse collapse" aria-labelledby="headingSpirituality" data-bs-parent="#shadbalaImpactAccordion">
                                <div class="accordion-body">
                                    High Shadbala for Rahu and Ketu enhances spiritual awareness and guides individuals toward resolving karmic lessons.
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item border-0">
                            ...
                            <div id="collapseTiming" class="accordion-collapse collapse" aria-labelledby="headingTiming" data-bs-parent="#shadbalaImpactAccordion">
                                <div class="accordion-body">
                                    Planets with high Shadbala during transits amplify their influence, signaling key opportunities or challenges in life events.
                                </div>
                            </div>
                        </div>
                    </div>
                    <h5 class="mt-4 mb-3 text-primary d-flex align-items-center">
                        <i class="bi bi-book me-2"></i> ✨ Why Explore Shadbala?
                    </h5>
                    <p class="text-justify">
                        Shadbala analysis reveals the strength of planetary influences, empowering you to leverage strong planets for success and address weaker ones for personal growth and balance.
                    </p>
                </div>
            </div>
            <div class="col-12 col-md-5 text-center">
                <img src="<?php echo base_url('assets/images/FreeKundli/kundli2.png'); ?>" alt="Shadbala Chart Illustration" class="img-fluid rounded" style="max-height: 300px; height: auto; background-color: transparent;">
            </div>
        </div>
    </div>
    ...
    <section>
        <div class="container my-4">
            <h2 class="text-center mb-4 fw-bold" style="color: var(--red);">Astrologers For Shadbala Analysis</h2>
   ...
   <script>
    ...
    document.getElementById("kundliForm").addEventListener("submit", function (e) {
        ...
        switch (selectedFeature) {
            case "shadbala":
                apiUrl = "<?php echo base_url('User_Api_Controller/shadbala'); ?>";
                break;
            default:
                apiUrl = "<?php echo base_url('User_Api_Controller/shadbala'); ?>";
                break;
        ...
        fetch(apiUrl, {
            ...
            .then(data => {
                ...
                if (data.success) {
                   ...
                   if (selectedFeature === 'shadbala') {
    const shadbalaData = data.data?.data || {};
    const planets = Object.keys(shadbalaData.shadbala_in_rupa || {});
    let html = `
        <div class="alert alert-success">Shadbala Analysis Loaded</div>
    ...
    planets.forEach(planet => {
        html += `
            <tr>
                ...
                <td>${shadbalaData.ratio?.[planet] ? (shadbalaData.ratio[planet] * 100).toFixed(2) : 'N/A'}%</td>
            </tr>
        `;
    });
