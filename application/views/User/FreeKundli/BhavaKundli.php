...
<body>
    ...
    <div class="container p-3 my-4 rounded-3" style="background-color: #fff7b8;">
        <h3 class="text-center mb-3">Bhava Kundli</h3>
            ...
            <div class="col-12 col-md-6">
                <div class="text-center">
                    ...
                    <form id="kundliForm" class="p-3 bg-white shadow rounded">
                        ...
                        <label class="m-2">Birth Date and Time</label>
                        <div class="row mt-2">
                        ...
                        <center>
                            <button type="submit" class="btn my-2 p-2 fw-bold rounded-1"
                                style="background-color: var(--yellow);">Generate Bhava Kundli</button>
                        </center>
            ...
            <div class="col-12 col-md-7">
                <div class="card shadow-sm border-0 p-4">
                    <h5 class="mt-0 mb-3 text-primary d-flex align-items-center">
                        <i class="bi bi-stars me-2"></i> 🔮 How Bhava Kundli Impacts Life
                    </h5>
