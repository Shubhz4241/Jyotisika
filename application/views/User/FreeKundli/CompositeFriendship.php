...
<body>
    ...
    <div class="container p-3 my-4 rounded-3" style="background-color: #fff7b8;  ">
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <h5>Friendship Compatibility by Birth Details</h5>
    ...
    <section>
    <div class="container my-4">
        <h2 class="text-center mb-4 fw-bold" style="color: var(--red);">Astrologers For Composite Friendship</h2>
        <div class="row g-4">
                            ...
                            <div class="card-body d-flex flex-column justify-content-between">
                                <div>
                                    ...
                                    <div class="mb-2">
                                        <div class="d-flex align-items-center mb-1">
                                            <img src="<?php echo base_url("assets/images/star.png") ?>" width="15" class="me-1">
                                            <small><?php echo $astrologer["specialties"] ?></small>
                                        </div>
                                        <div class="d-flex align-items-center mb-1">
                                            <img src="<?php echo base_url("assets/images/experience.png") ?>" width="15" class="me-1">
                                            <small><?php echo $astrologer["experience"] ?>+ Years</small>
                                        </div>
                                        <div class="d-flex align-items-center mb-1">
                                            <img src="<?php echo base_url("assets/images/money.png") ?>" width="15" class="me-1">
                                            <small>₹<?php echo $astrologer["price_per_minute"] ?> / min</small>
                                        </div>
                                        <div class="d-flex align-items-center mb-1">
                                            <img src="<?php echo base_url("assets/images/language.png") ?>" width="15" class="me-1">
                                                ...
                                                <?php
                                                    if (!empty($astrologer['chat_expire_on'])) {
                                                        ...
                                                        if ($expire > $now) {
                                                            ...
                                                            $seconds = $interval->s;
                                                            echo "<small class='ms-1 text-danger'>Wait: {$waitTimeMinutes} min {$seconds} sec</small>";
                                                        }
                                                    }
                                                ?>
                                            <?php else: ?>
                                ...
                                <div class="d-flex gap-2 mt-3">
                                    <?php if ($this->session->userdata('user_id')): ?>
                                        <button class="btn btn-sm w-50" style="background-color: var(--yellow);" onclick="checkBalance(
                                    ...
                                    <?php else: ?>
                                        <button class="chatlink btn btn-sm w-50 btnlog" style="background-color: var(--yellow);">Chat</button>
                                    <?php endif; ?>

                                    <?php if ($this->session->userdata('user_id')): ?>
                                        <button class="btn btn-sm btn-outline-success w-50">Call</button>
                                    <?php else: ?>
                                        <button class="btn btn-sm btn-outline-dark w-50">Call</button>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
 ...
 -->
    ...
    <script>
        ...
        document.getElementById("kundliForm").addEventListener("submit", function (e) {
            ...
            const selectedFeature = "composite_friendship";
