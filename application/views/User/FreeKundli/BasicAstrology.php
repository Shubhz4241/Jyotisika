...
.text-primary {
    color: #000000ff !important; /* A professional blue to contrast with yellow background */
}
        ...
        <div class="col-12 col-md-6">
            ...
            <div class="mt-2" style="text-align: justify; padding: 0 20px;">
                <p style="font-weight: 300;">
                    Basic Astrology is the foundational system for understanding how celestial bodies influence human life.
                    Rooted in ancient wisdom, it interprets the positioning and movement of planets, stars, and luminaries
                ...
                <div class="mt-4 px-2">
                    ...
                    <p class="text-justify mb-4">
                        The zodiac is divided into 12 signs, each representing a unique archetype with distinct qualities.
                    ...
                    <p class="text-justify mb-4">
                        Nine planets in Vedic astrology—Sun, Moon, Mars, Mercury, Jupiter, Venus, Saturn, Rahu, and Ketu—
                        govern specific areas like intellect, emotions, discipline, love, and spiritual growth. Their placement defines strengths,
                        challenges, and life patterns.
                    </p>
                    <h6 class="fw-semibold mb-2">Houses (Bhavas):</h6>
                    <p class="text-justify mb-4">
                        The horoscope is segmented into 12 houses, each ruling aspects such as career, relationships, health, wealth, and family.
                    ...
                    <p class="text-justify mb-4">
                        The rising sign at the time of birth sets the first house and influences the entire chart. It plays a vital role
                    ...
                    <p class="text-justify mb-4">
                        There are 27 Nakshatras that divide the zodiac further, providing detailed insights into personality traits,
                        karmic influences, and timing of events.
                    </p>
                    <h6 class="fw-semibold mb-2">Tithi, Karana, Yoga, Vaar:</h6>
                    <p class="text-justify mb-4">
                        These Panchang elements determine the quality of a particular day and the nature of energies at the time of birth.
                        Tithi relates to lunar phases, Yoga to planetary combinations, Karana to half-tithis, and Vaar to the day of the week.
                    </p>
                </div>
                <div class="mt-4 px-2">
                    <h5 class="fw-bold mb-3">Modern Astrology Insights:</h5>
                    <p class="text-justify mb-4">
                        Modern astrology integrates traditional knowledge with contemporary understanding, offering insights into psychological traits and life events.
                        It emphasizes personal growth, self-awareness, and the interconnectedness of celestial patterns with human experiences.
                    </p>
         ...
         <div class="col-12">
                    ...
                    <p class="text-justify mb-4">
                        Transits involve the movement of planets in real-time and their interactions with an individual's natal chart.
                        These transits can indicate periods of change, opportunity, or challenge, providing a dynamic layer to astrological interpretations.
                    </p>
                    <h6 class="fw-semibold mb-2">Astrology and Technology:</h6>
                    <p class="text-justify mb-4">
                        With advancements in technology, astrology has become more accessible through software and apps that generate detailed charts and predictions.
 ...
 <div class="container my-4">
    <div class="row align-items-center">
            ...
            <div class="card shadow-sm border-0 p-4">
                ...
                <div class="accordion" id="astrologyImpactAccordion">
                    <div class="accordion-item border-0">
                        ...
                        <div id="collapsePersonality" class="accordion-collapse collapse" aria-labelledby="headingPersonality" data-bs-parent="#astrologyImpactAccordion">
                            <div class="accordion-body">
                                Astrology helps decode inner traits, emotional patterns, and mental tendencies, offering a deeper understanding of your unique personality.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-0">
                        ...
                        <div id="collapseCareer" class="accordion-collapse collapse" aria-labelledby="headingCareer" data-bs-parent="#astrologyImpactAccordion">
                            <div class="accordion-body">
                                Planetary positions reveal career inclinations, financial strengths, and optimal timing for professional success.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-0">
                        ...
                        <div id="collapseRelationships" class="accordion-collapse collapse" aria-labelledby="headingRelationships" data-bs-parent="#astrologyImpactAccordion">
                            <div class="accordion-body">
                                Compatibility and harmony in relationships can be assessed through zodiac sign and house interactions, guiding better partnerships.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-0">
                        ...
                        <div id="collapseHealth" class="accordion-collapse collapse" aria-labelledby="headingHealth" data-bs-parent="#astrologyImpactAccordion">
                            <div class="accordion-body">
                                Certain houses and planets indicate health patterns and potential vulnerabilities, aiding in proactive wellness planning.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-0">
                        ...
                        <div id="collapseSpirituality" class="accordion-collapse collapse" aria-labelledby="headingSpirituality" data-bs-parent="#astrologyImpactAccordion">
                            <div class="accordion-body">
                                Astrology reflects past karma and guides spiritual growth, helping you align with your life’s purpose.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item border-0">
                        ...
                        <div id="collapseTiming" class="accordion-collapse collapse" aria-labelledby="headingTiming" data-bs-parent="#astrologyImpactAccordion">
                            <div class="accordion-body">
                                Major life events are often linked with planetary periods (dashas) and transits, offering predictive insights for key moments.
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <p class="text-justify">
                    Understanding Basic Astrology provides a powerful tool for self-exploration, decision-making, and aligning with cosmic rhythms. Whether used for personal insight, timing decisions, or spiritual growth, it empowers individuals to navigate life with greater clarity and purpose.
                </p>
            </div>
        ...
        <div class="col-12 col-md-5 text-center">
            <img src="<?php echo base_url('assets/images/FreeKundli/kundli2.png'); ?>" alt="Kundli Chart Illustration" class="img-fluid rounded" style="max-width: 300px; height: auto; background-color: transparent;">
        </div>
    </div>
</div>
<section>
                ...
                <div class="card shadow-sm rounded-3 h-100" style="border: 1px solid var(--red); background-color: #fff;">
                    <div class="card-body p-3">
                        ...
                        <div class="d-flex flex-column gap-1 mb-2">
                            ...
                            <div class="d-flex align-items-center">
                                <small class="card-language text-success">Availaible</small>
                            </div>
                        </div>
                        <!-- Action Buttons -->
                        <div class="d-flex gap-2 mb-2">
