                ...
                <div class="container">
                    ...
                    <div class="row g-4 mb-4 justify-content-center">
                        <div class="col-md-3 col-sm-6">
                            <a href="<?php echo site_url('HRAdmin/ViewallAstrologers'); ?>" class="text-decoration-none text-dark">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <a href="<?php echo site_url('HRAdmin/ViewallPujaris'); ?>" class="text-decoration-none text-dark">
                                <div class="counter-card">
                                    <div class="counter-card-content">
                                        <h2 class="mt-1 counter">150+</h2>
                                        <p>Pujari</p>
