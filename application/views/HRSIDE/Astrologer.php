...
<body style="background-color: rgb(228, 236, 241);">
    <div class="d-flex">
        ...
        <div class="main mt-3">
            ...
            <main class="p-3">
                <div class="container">
                    <h4 class="float-start">Recent Astrologer Requests</h4>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="astrologerTable" role="tabpanel" tabindex="0">
    ...
    <script>
        ...
        async function fetchAstrologers() {
            try {
                ...
                filteredData = AstrologersData.filter(item => item.status === "New Request");
        ...
        function filterTable(status) {
            ...
            filteredData = AstrologersData.filter(item => item.status.toLowerCase() === mappedStatus.toLowerCase());
            currentPage = 1;
            displayData(currentPage);
        }
        ...
        function displayData(page) {
            ...
            if (paginatedData.length === 0) {
                tableBody.innerHTML = `<tr><td colspan="12" class="text-center text-muted">No Astrologers found.</td></tr>`;
                updatePagination();
                return;
            }
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ${isRejected ?
                                ...
                                '<button class="btn btn-sm btn-primary" onclick="window.location.href=\'AstrologerRequest\'">View</button>'
                            }
                        </td>
                    </tr>
                `;
        ...
        function filterData() {
            ...
            filteredData = AstrologersData.filter(item =>
        ...
        function deleteAstrologer(id) {
            // Find the index of the astrologer to delete
            const index = filteredData.findIndex(item => item.id === id);
            if (index !== -1) {
                // Remove the astrologer from the filteredData array
                filteredData.splice(index, 1);
                // Remove the astrologer from the AstrologersData array
                const dataIndex = AstrologersData.findIndex(item => item.id === id);
                if (dataIndex !== -1) {
                    AstrologersData.splice(dataIndex, 1);
                }
        ...
        document.addEventListener("DOMContentLoaded", fetchAstrologers);
    </script>
</body>
</html>
