    ...
    <div class="d-flex">
        ...
        <div class="main w-100">
            ...
            <div class="profile-container">
                <img src="<?php echo base_url('uploads/astrologer/' . $Astro['profile_image']); ?>" alt="user-image" class="profile-image">

                <div class="profile-details">
                    <div>
                        <p><strong>Name:</strong> <?= $Astro['name']; ?></p>
                        <p><strong>Contact No:</strong> <?= $Astro['contact']; ?></p>
                        <p><strong>Email:</strong> <?= $Astro['email']; ?></p>
                        <p><strong>Gender:</strong> <?= $Astro['gender']; ?></p>
                        <p><strong>Address:</strong> <?= $Astro['address']; ?></p>
                        <p><strong>Languages Known:</strong> <?= $Astro['languages']; ?></p>
                        <p><strong>Specialities:</strong> <?= $Astro['specialties']; ?></p>
                        <p><strong>Experience:</strong> <?= $Astro['experience']; ?> years</p>
                    </div>
                </div>
