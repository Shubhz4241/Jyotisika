    ...
    <div class="container-fluid ">
        <div class="row d-flex flex-row justify-content-center align-items-start gap-3 p-3"
            ...
            <div class="col-12 col-md-2 text-center">
                ...
                <div class="social-media mt-2">
                    <a href="#"><img src="<?php echo base_url('assets/images/facebook.png'); ?>" alt="Facebook"
                            style="width: 30px;"></a>
                    <a href="#"><img src="<?php echo base_url('assets/images/whatsapp.png'); ?>" alt="WhatsApp"
                            style="width: 30px;"></a>
                    <a href="#"><img src="<?php echo base_url('assets/images/youtube.png'); ?>" alt="YouTube"
                            style="width: 30px;"></a>
                    <a href="#"><img src="<?php echo base_url('assets/images/instagram.png'); ?>" alt="Instagram"
                            style="width: 30px;"></a>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-4 col-md-2">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="#" class="footer-links"><?php echo $this->lang->line('Panchang') ?: "Panchang"; ?></a>
                    </li>
                    <li><a href="#"
                            class="footer-links"><?php echo $this->lang->line('Horoscope') ?: "Horoscope"; ?></a></li>
                    <li><a href="#"
                            class="footer-links"><?php echo $this->lang->line('Festivals') ?: "Festivals"; ?></a></li>
                    <li><a href="#" class="footer-links"><?php echo $this->lang->line('Remedies') ?: "Remedies"; ?></a>
                    </li>
                </ul>
            </div>
            <!-- Column 4: General Links -->
            <div class="col-12 col-sm-4 col-md-2">
                <h5 class="fw-bold"><?php echo $this->lang->line('General_Links') ?: "General Links"; ?></h5>
                <ul class="list-unstyled">
                    <li><a href="<?php echo base_url("privacypolicy") ?>" class="footer-links">
                            <?php echo $this->lang->line('Privacy_Policy') ?: "Privacy Policy"; ?></a></li>
                    <li><a href="#" class="footer-links"><?php echo $this->lang->line('Home') ?: "Home"; ?></a></li>
                    <li><a href="#"
                            class="footer-links"><?php echo $this->lang->line('Astrology') ?: "Astrology"; ?></a></li>
                    <li><a href="#" class="footer-links"><?php echo $this->lang->line('Services') ?: "Services"; ?></a>
                    </li>
                    <li><a href="#"
            ...
            <div class="col-12 col-sm-4 col-md-2">
                <h5 class="fw-bold"><?php echo $this->lang->line('Online_Consultations') ?: "Online Consultations"; ?>
                </h5>
                <ul class="list-unstyled">
                    <li><a href="#"
        ...
        <div class="row">
            <div class="col-12 text-center bg-white p-2">
                <p class="text-dark">
                    Design By : <span><img src="<?php echo base_url('assets/images/manasviTechSolutionLogo.png'); ?>"
                            alt="Manasvi Tech Solution" style="width: 120px;"></span>
                    This site is designed, hosted and maintained by <a class="text-dark text-decoration-none"
