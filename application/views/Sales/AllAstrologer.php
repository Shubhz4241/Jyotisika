                    ...
                    <div class="container">
                        <div class="row g-4" id="astrologer-list">
                            ...
                            <div class="col-md-4 col-sm-6 astrologer-card">
                                <a href="<?php echo site_url('viewastrologerprofile'); ?>" class="text-decoration-none text-dark">
                                    <div class="profile-card">
                                        <img src="https://randomuser.me/api/portraits/women/42.jpg" alt="Astrologer John Smith">
                            ...
                            <div class="col-md-4 col-sm-6 astrologer-card">
                                <a href="<?php echo site_url('viewastrologerprofile'); ?>" class="text-decoration-none text-dark">
                                    <div class="profile-card">
                                        <img src="https://randomuser.me/api/portraits/men/10.jpg" alt="Astrologer Sarah Lee">
                            ...
                            <div class="col-md-4 col-sm-6 astrologer-card">
                                <a href="<?php echo site_url('viewastrologerprofile'); ?>" class="text-decoration-none text-dark">
                                    <div class="profile-card">
                                        <img src="https://randomuser.me/api/portraits/women/50.jpg" alt="Astrologer Mark Evan">
                            ...
                            <div class="col-md-4 col-sm-6 astrologer-card">
                                <a href="<?php echo site_url('viewastrologerprofile'); ?>" class="text-decoration-none text-dark">
                                    <div class="profile-card">
                                        <img src="https://randomuser.me/api/portraits/men/18.jpg" alt="Astrologer Lily Brown">
                            ...
                            <div class="col-md-4 col-sm-6 astrologer-card">
                                <a href="<?php echo site_url('viewastrologerprofile'); ?>" class="text-decoration-none text-dark">
                                    <div class="profile-card">
                                        <img src="https://randomuser.me/api/portraits/women/24.jpg" alt="Astrologer Jane Doe">
                                        <div class="name">Astrologer Jane Doe</div>
                                    </div>
                                </a>
                            </div>
