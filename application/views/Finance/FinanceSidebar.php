...
<aside id="sidebar" class="sidebar-toggle">
    ...
    <ul class="sidebar-nav p-0">
        ...
        <li class="sidebar-item">
            <a href="<?php echo base_url() . 'financeastrologer'; ?>" class="sidebar-link " id="ManasviHome-link" style="font-size: 16px;">
                <i class="bi bi-house-fill" style="color: white;"></i>
                <span class="ms-1" style="color: white;">Astrologers</span>
            </a>
        </li>

        <li class="sidebar-item">
            <a href="<?php echo base_url() . 'FinancePoojari'; ?>" class="sidebar-link " id="ManasviHome-link" style="font-size: 16px;">
                <i class="bi bi-house-fill" style="color: white;"></i>
                <span class="ms-1" style="color: white;">Poojari</span>
            </a>
        </li>

       
        <li class="sidebar-item">
            <a href="<?php echo base_url() . 'financeprofile'; ?>" class="sidebar-link" id="InterviewAnalysis-link" style="font-size: 16px;">
